...
:: SETTINGS=${SETTINGS:-"../project/src/UserSettings.json"}
@echo on


:: compile source code into bin/
javac -cp .;gson-2.8.2.jar;./bin/;spoon-core-6.1.0-jar-with-dependencies.jar -d bin project/src/*.java
echo "Source code compiled"

:: run Main filename settings
:: usage: <filename|foldername> [<userSettings.json>]
java -cp .;gson-2.8.2.jar;./bin/;spoon-core-6.1.0-jar-with-dependencies.jar Main "%FILENAME%" "%SETTINGS%"