...
class W_weightedMethodCountLoCTest {
    ...
    private static W_weightedMethodCountLoC w = new W_weightedMethodCountLoC(c, "");
    ...
    void call() throws Exception {
        assertEquals((new WorkerReport(52)).getValue(), w.call().getValue());
    }
}